...
class DependencyInjector {
  ...
  // Mapa
  final _instanceMap = Map<Type, _InstanceGenarator<Object>>();
...
class _InstanceGenarator<T> {

  T? _instance;
  bool _isFirstGet = false;

  final InstanceCreator<T> _instanceCreator;
  _InstanceGenarator(this._instanceCreator, bool isSingleton) :_isFirstGet = isSingleton;
